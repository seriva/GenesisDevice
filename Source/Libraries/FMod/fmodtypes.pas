...
type
  ...
  (
    ...
    FMOD_ERR_EVENT_MAXSTREAMS,      (* Event failed because 'Max streams' was hit when FMOD_INIT_FAIL_ON_MAXSTREAMS was specified. *_
...
const
    ...
    FMOD_DONTRESTOREVIRTUAL     = $80000000;  (* When a sound is cut out because of virtual voices, just stop it instead of making it restart later, which can sometimes sound unnatural. *)
...
*)
type
 // FMOD_CHANNEL_CALLBACK       = function (channel: FMOD_CHANNEL; callbacktype: FMOD_CHANNEL_CALLBACK;      command: Integer; commanddata1:word; commanddata2:word ): FMOD_RESULT; stdcall;                              

...
begin
  case errcode of
    ...
    FMOD_ERR_CDDA_INVALID_DEVICE:    FMOD_ErrorString := 'Couldnt find the specified device.';
    ...
    FMOD_ERR_DSP_NOTFOUND:           FMOD_ErrorString := 'DSP connection error.  Couldnt find the DSP unit specified.';
    ...
    FMOD_ERR_FILE_COULDNOTSEEK:      FMOD_ErrorString := 'Couldnt perform seek operation.';
    ...
    FMOD_ERR_MAXAUDIBLE:             FMOD_ErrorString := 'Reached maximum audible playback count for this sounds soundgroup.';
    ...
    FMOD_ERR_MEMORY_CANTPOINT:       FMOD_ErrorString := 'Cant use FMOD_OPENMEMORY_POINT on non PCM source data, or non mp3/xma/adpcm data if FMOD_CREATECOMPRESSEDSAMPLE was used.';
    ...
    FMOD_ERR_NET_CONNECT:            FMOD_ErrorString := 'Couldnt connect to the specified host.';
    ...
    FMOD_ERR_NET_URL:                FMOD_ErrorString := 'The specified URL couldnt be resolved.';
    ...
    FMOD_ERR_REVERB_INSTANCE:        FMOD_ErrorString := 'Specified Instance in FMOD_REVERB_PROPERTIES couldnt be set. Most likely because another application has locked the EAX4 FX slot.';
    ...
    FMOD_ERR_SUBSOUND_ALLOCATED:     FMOD_ErrorString := 'This subsound is already being used by another sound, you cannot have more than one parent to a sound.  Null out the other parents entry first.';
 ...
 //   FMOD_ERR_UNIMPLEMENTED:          FMOD_ErrorString := 'Something in FMOD hasnt been implemented when it should be! contact support!';
    ...
    FMOD_ERR_EVENT_INTERNAL:         FMOD_ErrorString := 'An error occured that wasnt supposed to.  See debug log for reason.';
    FMOD_ERR_EVENT_INFOONLY:         FMOD_ErrorString := 'Cant execute this command on an EVENT_INFOONLY event.';
